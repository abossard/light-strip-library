...
import { Bend, LEDColor, ColorSetup, defaultParameters } from './types';
import { Logger } from './logger';

export const LightStripView: React.FC<{ length?: number; numLEDs?: number; addressableLEDs?: number; colorSetup?: ColorSetup }> = ({
  ...
  const draw = () => {
    ...
    const bendInterval = bends.length > 0 ? Math.floor(numLEDs / (bends.length + 1)) : numLEDs;
    let bendIndex = 0;
